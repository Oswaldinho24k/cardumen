import { Slider, RevealComponent } from "./common";
...
export default function Testimonials() {
  return (
    <section id="testimonials">
      <RevealComponent>
        <p className="text-3xl font-bold text-center">Testimonios</p>
                ...
                <div className="w-full max-w-2xl xl:max-w-none xl:flex-auto px-10 py-10 md:py-20 md:px-16 lg:px-20 ">
                  <figure className="relative isolate pt-6 sm:pt-12">
                    ...
                    <blockquote className="text-xl font-semibold leading-8 sm:text-2xl sm:leading-9">
                      <p>...Cardumen con alma de tiburón...</p>
                    </blockquote>
                    <figcaption className="mt-8 text-base">
                      <div className="font-semibold">
                        Oswaldo Martinez {item}
                      </div>
                      <div className="mt-1 text-gray-400">
                        Campeón de Oceanman XD
                      </div>
                    </figcaption>
                  </figure>
                </div>
